...
const sessionTemplateRoutes = require('./routes/sessionTemplates');
...
app.use('/api/v1/predefined-workouts', sessionTemplateRoutes);
app.use('/api/v1/external-activities', externalActivityRoutes);
app.use('/api/v1/disciplines', disciplineRoutes);
app.use('/api/v1/workout-types', sessionTypeRoutes);
...
app.use('/api/v1/workout-logs', sessionLogRoutes);
