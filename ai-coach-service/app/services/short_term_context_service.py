...
EXTRACT_AND_RECONCILE_PROMPT = (
    ...
    "NEVER store something the COACH proposed or asked about that the athlete "
    "did not confirm — an unanswered clarifying question (\"do you mean X? I "
    "can add it\") is NOT an athlete fact.\n"
    "NEVER store which sports the athlete wants in their training (\"is "
    "interested in climbing\", \"wants to get into triathlon\") — training "
    "interests live in the profile (updated via the update_sport_preferences "
    "tool during chat), and a parallel memory copy drifts and contradicts it. "
    "Goals ABOUT a sport (\"finish an Ironman in 2027\", \"climb V5 by "
    "winter\") are still goals and still belong here.\n"
