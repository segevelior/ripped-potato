...
def get_workout_tools() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        # ==================== WORKOUT LOG TOOLS ====================
        {
            ...
            "function": {
                "name": "log_workout",
                "description": "Log a workout the user actually performed to their workout history (it also appears on their calendar). Use this to record real training sessions with sets, reps, weights, and RPE. Logs are performed sessions only — to put a future/planned workout on the calendar use schedule_to_calendar instead.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "title": {
